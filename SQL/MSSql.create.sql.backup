...
CREATE TABLE [Квартал] (
	 ...
	 [Кладбище_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Захоронение] ADD CONSTRAINT [Захоронение_FКвартал_0] FOREIGN KEY ([Квартал_m0]) REFERENCES [Квартал]
CREATE INDEX Захоронение_IКвартал_m0 on [Захоронение] ([Квартал_m0])

 ALTER TABLE [Квартал] ADD CONSTRAINT [Квартал_FКладбище_0] FOREIGN KEY ([Кладбище_m0]) REFERENCES [Кладбище]
CREATE INDEX Квартал_IКладбище_m0 on [Квартал] ([Кладбище_m0])
